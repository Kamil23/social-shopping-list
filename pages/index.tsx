...
const FavoritesList = ({ favoritesList, handleCreateSession, isLoading }) => {
  ...
  return (
    <div className="flex flex-col">
      {/** header */}
      <h1 className="flex-1 text-center px-5 py-10 font-anek-latin text-xl text-dark-blue border-b border-[#E3EAF0]">
        Twoje listy
      </h1>

      {/** list */}
      <div className="flex-1 my-10 mx-5 flex flex-col space-y-4 overflow-y-auto mb-[225px]">
      ...
      {/** bottom bar */}
      <div className="flex-1 w-full items-center fixed bottom-0 flex flex-col mt-5 space-y-5 px-5 py-10 bg-[#EFF7FF] border-t border-[#E4F2FF]">
        <Button
          ...
          additionalStyle={{ padding: "16px", fontSize: "14px" }}
        />
        <Button
...
const ListElement = ({ list }) => {
  ...
  return (
    <button
      className="px-4 py-6 flex rounded-lg bg-[#EFF7FF] space-x-4 justify-between items-center"
    ...
    >
      ...
      <div className="flex flex-col items-start">
        <span className="font-anek-latin text-lg text-[#3D3D3E]">{name}</span>
